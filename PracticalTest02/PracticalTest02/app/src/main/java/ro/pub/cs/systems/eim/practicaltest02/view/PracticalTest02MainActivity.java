...
public class PracticalTest02MainActivity extends AppCompatActivity {
    ...
    private EditText operatorEditText = null;
    ...
    private ResultButtonClickListener resultButtonClickListener = new ResultButtonClickListener();
    private class ResultButtonClickListener implements Button.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            clientThread = new ClientThread(
                    clientAddress, Integer.parseInt(clientPort), operator, operand1, operand2, resultTextView
            );
            clientThread.start();
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        operatorEditText = (EditText)findViewById(R.id.operator_edit_text);
        ...
        sendOperationButton = (Button)findViewById(R.id.client_send_button);
        sendOperationButton.setOnClickListener(resultButtonClickListener);
